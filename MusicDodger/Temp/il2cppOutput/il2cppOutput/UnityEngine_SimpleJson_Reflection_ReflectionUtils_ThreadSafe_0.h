...
struct  ThreadSafeDictionary_2_t414  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t413 * ____valueFactory_1;
	...
	Dictionary_2_t1675 * ____dictionary_2;
};
