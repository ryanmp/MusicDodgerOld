...
struct  ThreadSafeDictionary_2_t416  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t415 * ____valueFactory_1;
	...
	Dictionary_2_t1677 * ____dictionary_2;
};
