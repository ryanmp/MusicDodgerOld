...
struct  X509Store_t796  : public Object_t
{
	...
	X509Certificate2Collection_t787 * ___list_2;
	...
	X509Store_t810 * ___store_4;
};
struct X509Store_t796_StaticFields{
	...
	Dictionary_2_t436 * ___U3CU3Ef__switchU24mapF_5;
};
